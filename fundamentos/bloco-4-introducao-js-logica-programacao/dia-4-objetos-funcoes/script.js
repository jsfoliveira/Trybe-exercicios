...
//   console.log(key);
// }
//EXERCICIO 03:Faça um novo for/in , mas agora mostre todos os valores das chaves do objeto
// for (let value in info) {
//   console.log(info[value]);
// }
//??EXERCICIO 05: gora, defina um segundo objeto com a mesma estrutura (as mesmas chaves) do primeiro e os seguintes valores: 'Tio Patinhas', 'Christmas on Bear Mountain, Dell's Four Color Comics #178', 'O último MacPatinhas', 'Sim'. Então, imprima os valores de cada objeto juntos de acordo com cada uma das chaves
...
leitor.livrosFavoritos[3].push{
  titulo: "Harry Potter e o Prisioneiro de Azkaban",
};
console.log(leitor);
// ??faltaEXERCICIO 08:Acesse as chaves nome e livrosFavoritos e faça um console.log no seguinte formato: "Julia tem 2 livros favoritos"
// for (let key in leitor) {
// }
// console.log(
//   leitor["nome"] +
