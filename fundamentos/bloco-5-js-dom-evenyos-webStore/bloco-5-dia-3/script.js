...
input.addEventListener("input", function (event) {
  let alterarTexto = document.getElementsByClassName("tech")[0];
  alterarTexto.innerHTML = event.target.value;
});

// 4. Crie uma função que, ao clicar duas vezes em 'Meu top 3 do Spotrybefy', ele redirecione para alguma página;
let minhaPagina = document.getElementById("my-spotrybefy");
minhaPagina.addEventListener("dblclick", function () {
