...
// function somEstudantes (){
  const totalEstudante = lesson1.numeroEstudantes + lesson2.numeroEstudantes + lesson3.numeroEstudantes;
  
// }
console.log(totalEstudante);

//7. Crie uma função que obtenha o valor da chave de acordo com a sua posição no objeto.
function valorPosicao (objeto, indice){
  return Object.values(lesson1)[indice];
}
console.log(valorPosicao(lesson1,0));

//8. Crie uma função que verifique se o par (chave / valor) existe na função. Essa função deve possuir três parâmetros, sendo eles: o objeto, o nome da chave e o valor da chave.
function parExiste (objeto, chave, valor){
  const valor1 =  Object.entries(objeto);
  console.log(valor1);
  for(let i =0; i < valor1.length; i += 1){
    if (valor1[0][0] === chave && valor1[0][1] === valor) { return true;
    } else {
    return false;
  }
  }
